  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved case as @case" do
        ...
        post :create, {:case => { "message" => "invalid value" }}, valid_session
        assigns(:case).should be_a_new(Case)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested case" do
        ...
        Case.any_instance.should_receive(:update).with({ "message" => "MyString" })
        put :update, {:id => case.to_param, :case => { "message" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the case as @case" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Case.any_instance.stub(:save).and_return(false)
        put :update, {:id => case.to_param, :case => { "message" => "invalid value" }}, valid_session
        assigns(:case).should eq(case)
      end
